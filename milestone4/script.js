...
saveBtn.addEventListener('click', function () {
    var updatedName = displayName.textContent;
    var updatedEmail = displayEmail.textContent;
    var updatedPhone = displayPhone.textContent;
    var updatedEducation = displayEducation.textContent;
    var updatedWorkExperience = displayWorkExperience.textContent;
